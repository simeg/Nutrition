...
import com.example.android.nutrition.activities.FavoritesActivity;
...
public class FoodListAdapter extends CursorAdapter {
    ...
    public static class ViewHolder {
        ...
        public ViewHolder(View view) {
            nameView = (TextView) view.findViewById(R.id.list_item_food_textview);
        }
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        viewHolder.nameView.setText(cursor.getString(FavoritesActivity.FavoritesFragment.COL_FOOD_NAME));
    }
}